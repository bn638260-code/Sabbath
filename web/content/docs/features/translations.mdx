...
SabbathCue ships with ten Bible translations spanning English, Spanish, French,
...
SabbathCue imports **340k+ cross-references** (the bundled file currently has
...
The transport-bar translation picker lists every bundled translation. The active
translation is the one rendered on the live overlay; switching here is the same
surface that voice commands and remote control hit under the hood.
