...
| **STT**       | Local Vosk worker (default), Deepgram WebSocket + REST (`tokio-tungstenite`), or Gladia live streaming |
...
- **Gladia** creates a live session through the Gladia API and streams audio
  into the same transcript event pipeline.
