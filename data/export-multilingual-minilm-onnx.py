#!/usr/bin/env python3
"""Export paraphrase-multilingual-MiniLM-L12-v2 to the ONNX layout used by SabbathCue."""
...
MODELS_DIR = ROOT / "models" / "multilingual-minilm-l12-v2"
MODELS_DIR_INT8 = ROOT / "models" / "multilingual-minilm-l12-v2-int8"
...
def main() -> None:
    ...
    if fp32_path.exists() and int8_path.exists():
        print("Multilingual ONNX exports already exist; nothing to do.")
        return
    ...
    print("Quantizing multilingual ONNX model to INT8...")
