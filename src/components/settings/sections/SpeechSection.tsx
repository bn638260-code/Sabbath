    ...
    <div className="flex flex-col gap-6">
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[0.625rem] leading-relaxed text-muted-foreground">
                Uses streaming sherpa-onnx Zipformer transcription with Bible
                hotword biasing. Free after the model is installed, and audio
      ...
      {sttProvider === "sherpa" && (
        <div className="flex flex-col gap-3 rounded-lg border border-white/5 bg-white/5 p-3">
          ...
          <p className="text-[0.625rem] leading-relaxed text-muted-foreground">
            Sherpa uses the streaming Zipformer English model with hotword
            biasing for Bible terms. Install{" "}
