...
import type { ServiceEventLogEntry, ServiceItem, ServicePlan } from "@/types/service-plan"
...
export function deleteServiceItem(plan: ServicePlan, itemId: string): ServicePlan {
  return {
    ...plan,
...
export function duplicateServiceItem(plan: ServicePlan, itemId: string): ServicePlan {
...
export function setActiveServiceItem(plan: ServicePlan, itemId: string | null): ServicePlan {
...
export function setServiceItemReady(plan: ServicePlan, itemId: string): ServicePlan {
