...
export const HELP_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Account - view your signed-in email and approved computers, sign out, or delete your account; administrators also manage the KNFC pilot here.",
      "Help - restart the interactive tutorial, contact the developer, view keyboard shortcuts, and check for updates.",
    ],
  },
  {
    title: "Pilot access and account",
    items: [
      "Participants register, confirm their email, sign in, redeem an administrator-issued single-use invitation, and acknowledge training.",
      "Pilot access requires an active church membership and an active pilot with payment, onboarding, and agreement dates recorded.",
      "Open System Settings > Account to manage approved computers, sign out, or permanently delete your account.",
      "Administrators use the Account panel to manage agreement capacity, Schedule A churches, invitations, memberships, and pilot activation.",
    ],
  },
  {
